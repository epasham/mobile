...
$scope.currentChild = {
  selected: $scope.children[0] // set the initial selected option
};
$scope.setActiveChild = function(currentChild) {

    $scope.currentChild = currentChild;

};
$scope.$watch('currentChild.selected', function (currentChild) {
  $scope.setActiveChild(currentChild);
});
